...
> **Update, 25 September 2026.** The comparison with the Opus 4.x family below is out of
> date. The current Claude models all think adaptively, deciding per request whether to
> think at all, and Anthropic's docs now say to lower the effort level first when a task
> is getting more thinking than it needs.
