...
export const appGroups: AppGroup[] = [
  ...
  },
  {
    ...
    workflow: 'Durable memory now lives in versioned files beside the work itself; the old notes vault is kept as an archive.',
    items: [
      { name: 'Obsidian', role: 'The old notes vault — linked and git-backed, kept as an archive since August 2026', url: 'https://obsidian.md' },
