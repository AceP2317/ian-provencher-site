...
export const SECTIONS: Section[] = [
  {
    ...
    description: 'Ian Provencher — AI orchestrator.', dataSource: '—',
    group: 'me',
  },
  {
    slug: 'about', title: 'About', icon: 'user-round', order: 1,
    status: 'live', kind: 'special',
    description: 'Who I am — the operations background, the practice, and how to reach me.',
    dataSource: '—',
    group: 'me',
  },
  {
    ...
    status: 'live', kind: 'special',
    description: 'The résumé — what I’ve done and what I build.',
  ...
  },
  {
    ...
    description: 'AI From the Floor — an AI news show, read through an operator’s lens.',
  ...
  },
  {
    ...
    description: 'Roles worth a look — a scored snapshot of postings, paused since 1 September 2026.',
  ...
  },
  {
    ...
    status: 'live', kind: 'special', accent: 'cyan',
    description: 'A public-safe window into my private ops console.',
  ...
  },
  {
    ...
    status: 'live', kind: 'special', accent: 'cyan',
    description: 'How I direct AI — the operating doctrine, the hooks that wire it in, and the live status-line instrument.',
