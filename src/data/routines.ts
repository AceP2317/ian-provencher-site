  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        trigger: 'A daily end-to-end run through the real pipeline',
        channel: 'Push on failure',
        purpose: 'Files a real item the whole way through — capture, model, note, ledger — and shouts if any stage drops it. Checking that each service is UP would pass while the chain between them was broken; only something that travels the entire path can prove the path still works.',
      },
    ],
  },
  {
