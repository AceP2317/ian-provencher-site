...
export const resume = {
  headline:
    'AI orchestrator, with supply-chain operations underneath — production LLM and agentic systems, directed and shipped end to end.',
  summary:
    'I ship production software end to end by directing fleets of CLI coding agents and LLM pipelines — Python and TypeScript, React front ends on Cloudflare’s edge, real-time data systems, and cross-platform desktop and mobile apps — designing the system, steering the agents, and holding the review gate on what they produce. Production LLM features, tool-use pipelines and agent fleets are how the work gets made. The domain underneath is supply-chain operations — MRP, BOM, planning and logistics — and it decides what gets built.',
  ...
  experience: [
    {
      ...
      dates: '',
      summary:
        'A one-person software practice: custom software for small local businesses, and supply-chain tools built to order for manufacturers, each designed and shipped end to end.',
      highlights: [
    ...
    },
    {
      ...
      highlights: [
        'Work in the MRP and BOM logic underneath planning and material constraints.',
