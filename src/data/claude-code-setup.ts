...
export type SetupAccent = 'amber' | 'cyan' | 'indigo' | 'violet';
...
export const claudeCodeSetup: ClaudeCodeSetup = {
  ...
  stations: [
    ...
    },
    {
      ...
      why: 'The model — whichever Claude is current — reads the actual repository, runs tools, edits files, and executes. On its own it’s a brilliant generalist. Everything orbiting it here is what makes it run like a disciplined senior engineer who already knows my estate.',
      zone: 'core',
      accent: 'amber',
    },
    {
    ...
    },
    {
      ...
      why: 'Shell hooks the harness runs on its own — they mirror the canonical doctrine into place, report what the overnight checks found, and refuse unsafe command shapes before they run. The discipline isn’t something I remember to switch on; the hooks make it the default state of every session.',
      zone: 'layer',
      accent: 'cyan',
    },
    {
    ...
    },
    {
      ...
      why: 'The Model Context Protocol connects the engine to tools outside the codebase — the browser, mail, calendar and file storage — through a typed, permissioned interface. The repo is the workshop; MCP is everything else on the bench.',
      zone: 'layer',
      accent: 'cyan',
    },
    {
  ...
  tour: [
    ...
    },
    {
      ...
      body: 'SessionStart hooks put the doctrine in place and report the overnight checks on their own. Discipline is the default state of a session, not something I have to remember to switch on.',
    ...
    },
    {
      ...
      body: 'MCP connects the engine to the browser, mail, calendar and file storage — a typed, permissioned reach past the codebase itself.',
      focus: ['mcp', 'engine'],
    },
    {
